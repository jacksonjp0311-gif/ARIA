...
This document is normative for the ARIA `0.1.0-alpha.11` bootstrap implementation. Where prose and the machine-readable grammar disagree, `grammar/aria.ebnf`, `grammar/opcodes.json`, and the aggregate conformance suite define the executable contract for this alpha.
